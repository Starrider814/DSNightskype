...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "He'll probably be a little more pissed off if I try this.",
			GENERIC = "That'll only dull the razor",
			NOBITS = "Smooth...",
		},
		STORE =
		{
			GENERIC = "Can't put more in there.",
			NOTALLOWED = "Now why would I do that?",
			INUSE = "Move over, I need in.",
		},
		RUMMAGE =
		{	
			GENERIC = "I can't do that.",
			INUSE = "You should move over.",	
		},
        COOK =
        {
            GENERIC = "That'll taste like shit.",
            INUSE = "You should get your own pot.",
        },
        GIVETOPLAYER = 
        {
        	FULL = "They're too much of a packrat",
    	},
    	GIVEALLTOPLAYER = 
        {
        	FULL = "Their hoardin' all the shit!",
    	},
	},
	...
	ANNOUNCE_BOOMERANG = "Fuck! this thing comes back?",
	ANNOUNCE_CHARLIE = "3spoopy5me",
	ANNOUNCE_CHARLIE_ATTACK = "The Spoop! It Hurts",
	ANNOUNCE_COLD = "It's freezing out here",
	ANNOUNCE_CRAFTING_FAIL = "I need more stuff to do the stuff",
	ANNOUNCE_DEERCLOPS = "That sounded big!",
	ANNOUNCE_DUSK = "The sun is setting",
	ANNOUNCE_EAT =
	{
		GENERIC = "MMM!",
		PAINFUL = "That isn't good.",
		SPOILED = "That is straight up nasty",
		STALE = "I should probably have gotten that fresh.",
	},
	ANNOUNCE_ENTER_DARK = "I can't see shit!",
	ANNOUNCE_ENTER_LIGHT = "The Light!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "The knowledge! It's overwhelming",
	ANNOUNCE_HOUNDS = "Them puppies are comin' for me",
	ANNOUNCE_HUNGRY = "Sarah! I'm hungry!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Somethin big is close.",
	ANNOUNCE_HUNT_LOST_TRAIL = "And the trail goes cold.",
	ANNOUNCE_INV_FULL = "It's too heavy.",
	ANNOUNCE_KNOCKEDOUT = "Ohhh, I feel Woozy.",
	ANNOUNCE_LOWRESEARCH = "That wasn't just elementary, that was detention.",
	ANNOUNCE_MOSQUITOS = "bzz bzz yourself.",
	ANNOUNCE_NODANGERSLEEP = "The monsters scare me.",
	ANNOUNCE_NODAYSLEEP = "The sun is telling me to not sleep.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I don't need rest.",
	ANNOUNCE_NOHUNGERSLEEP = "I'm too hungry to sleep!",
	ANNOUNCE_NODANGERAFK = "I can't run away now!",
	ANNOUNCE_NO_TRAP = "(Staples) That was easy!",
	ANNOUNCE_PECKED = "Stop that!",
	ANNOUNCE_QUAKE = "Tremors!",
	ANNOUNCE_RESEARCH = "Did you know...",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_TORCH_OUT = "The fire's gone",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "Gross...",
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "I did it!",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "Y'all see this?",	
	ANNOUNCE_BECOMEGHOST = "ooOOoooOOOoOooo!!",
	ANNOUNCE_GHOSTDRAIN = "Them spoops be hauntin my mind 'n' shit",

	DESCRIBE_SAMECHARACTER = "Clones, what'cha gonna do?",
	
	BATTLECRY =
	{
		GENERIC = "Never Give Up! Never Surrender!",
		PIG = "Chris P. Bacon today, Crispy bacon tomorrow!",
		PREY = "I'm coming for you!",
		SPIDER = "Stomp on it!",
		SPIDER_WARRIOR = "Aaaaaaaaah!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "I let him get away",
		PIG = "It'll stay fresh this way",
		PREY = "I'm gonna get you last time",
		SPIDER = "They'll be back, and in greater numbers.",
		SPIDER_WARRIOR = "Damn, where'd he go?",
	},
	DESCRIBE =
	{
        PLAYER =
        {
            GENERIC = "It's %s!",
            ATTACKER = "%s looks to be picking a fight",
            MURDERER = "%s is a murderous sonofabitch",
            REVIVER = "%s, what a lifesaver.",
            GHOST = "%s should be more careful",
        },
		WILSON = 
		{
			GENERIC = "That's Wilson!",
		...
		MULTIPLAYER_PORTAL = "How does it even work?",
		WORMLIGHT = "Looks delicious.",
		WORM =
		{
		    PLANT = "Just a little earthworm",
		    DIRT = "Dirt, Just dirt",
		    WORM = "Worm, just worm",
		},

		EEL = "This will be delicious, ignoring the electric burns",
		EEL_COOKED = "getting electrocuted was worth it.",
		UNAGI = "I cooked it myself!",
		EYETURRET = "Watch out for that!",
		EYETURRET_ITEM = "I think it's sleeping?",
		MINOTAURHORN = "Gone running of the bulls up in this bitch!",
		...
		CALM = "I'm good",
		WARN = "Something's up",
		WAXING = "It's getting stronger.",
		STEADY = "It's holding steady",
		WANING = "It's going away",
		DAWN = "It's almost over!",
		NOMAGIC = "There are no disturbances in the force",
		},
		...
		RUINS_RUBBLE = "I can do something with this.",
		MULTITOOL_AXE_PICKAXE = "It's brilliant!",
		ORANGESTAFF = "This beats walking.",
		YELLOWAMULET = "Nice handwarmer",
        ...
        ANCIENT_ALTAR = "Long ago, this was used for something...arcane.",

        ANCIENT_ALTAR_BROKEN = "It needs to be fixed.",
		...
		{
			WAXING = "It's getting stronger.",
			STEADY = "It's staying the same",
			WANING = "Feels like it's receding.",
			DAWN = "Nightmare...almost...over",
			WARN = "Getting pretty magical around here.",
			CALM = "All is well.",
			NOMAGIC = "There's no magic around here.",
		},

		HOUNDSTOOTH="Dogteeth",
		ARMORSNURTLESHELL="I call dibs on Donatello.",
		BAT="Ye Bat!, ne Vampir",
		BATBAT = "Like batman, but more baseball.",
		BATWING="Is there even any meat on this?",
		BATWING_COOKED="I thought bats had like, super-rabies in them",
		BEDROLL_FURRY="Damn, I forgot my pillow again.",
		BUNNYMAN="Nice "bunny"",
		FLOWER_CAVE="Bioluminescence at it's best",
		FLOWER_CAVE_DOUBLE="Double the glow, double the better",
		FLOWER_CAVE_TRIPLE="Three's a croud.",
		GUANO="I wonder if there are carnivorous beetles in this.",
		LANTERN="Finally, there is more than campfire light!",
		LIGHTBULB="The last remnant of Edison's middle finger to Tesla.",
		MANRABBIT_TAIL="Is the tail the lucky part?",
		MUSHTREE_TALL  ="That would make one hell of a soup.",
		MUSHTREE_MEDIUM="I like mushrooms, but not that much.",
		MUSHTREE_SMALL ="",
