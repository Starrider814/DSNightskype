...
return {
	...
	DESCRIBE =
	{
		...
		NIGHTMARE_TIMEPIECE =
		{
			...
			WARN = "Getting pretty magical around here.",
			CALM = "All is well.",
			NOMAGIC = "There is no disturbance in the force",
		},

		HOUNDSTOOTH="Wrenched from the mouth of a dog.",
		ARMORSNURTLESHELL="Dibs on Donatello",
		BAT="Ye Bat, ne Vampir",
		BATBAT = "Bat^2?",
		BATWING="Is there even any meat on this?",
		BATWING_COOKED="I thought bats had super-rabies or something.",
		BEDROLL_FURRY="Damn, I forgot the pillow again",
		BUNNYMAN="Werebunny?",
		FLOWER_CAVE="Bioluminescence at its best",
		FLOWER_CAVE_DOUBLE="Another one, how quaint",
		FLOWER_CAVE_TRIPLE="How many flowers can grow in these bunches?",
		GUANO="Are there carnivorous beetles in this?",
		LANTERN="Finally, we don't have to rely on campfires anymore",
		LIGHTBULB="Edison's last remening middle finger to Tesla",
		MANRABBIT_TAIL="Is this the lucky part?",
		MUSHTREE_TALL  ="This may be the shrooms talking, but that's one big mushroom.",
		MUSHTREE_MEDIUM="Do the get bigger?",
